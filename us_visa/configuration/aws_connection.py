...
class S3Client:
    ...
    def __init__(self, region_name = REGION_NAME):
        """
        This class is used to get aws credentials from env_variable and create an connection with s3 buckets and raise an exception
        when environment variable is not set correctly.
        """
